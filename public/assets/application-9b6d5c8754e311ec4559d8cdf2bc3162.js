...
(function() {
  ...
  $(document).ready(function() {
    ...
    if (myElem != null) {
      return setInterval(refreshFeedPartial, 30000);
    }
  });
...
(function() {
  var refreshLatestPartial;

  refreshLatestPartial = function() {
    return $.ajax({
      url: "refresh-latest-messages"
    });
  };
  ...
  $(document).ready(function() {
    ...
    if (myElem != null) {
      return setInterval(refreshLatestPartial, 30000);
    }
  });

  $(document).on("click", ".bubble", function() {
    var url;
    if ($(this).attr("id") === "notification") {
