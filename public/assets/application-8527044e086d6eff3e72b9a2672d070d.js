...
(function() {
  var refreshFeedPartial, refreshLatestPartial, refreshNavbarPartial, time;

  time = (new Date()).getTime();

  refreshLatestPartial = function() {
    $.ajax({
      url: "/refresh-latest-messages?time=" + time
    });
    return time = (new Date()).getTime();
  };

  refreshFeedPartial = function() {
    return $.ajax({
      url: "/refresh-messages-feed"
    });
  };

  refreshNavbarPartial = function() {
    return $.ajax({
      url: "/refresh-navbar"
    });
  };
  ...
  $(document).on("click", ".conversation", function() {
    ...
    return $.ajax({
      ...
      success: function(html) {
        ...
        return $("#myConversationModal").modal("show");
      }
    });
  });
...
(function() {
  jQuery(function() {
    return $('#message_recipient_name').autocomplete({
...
(function() {
  $(function() {
    return $('.offer_value').change(function() {
      return $(this).next().next().val($(this).val() * $(this).next().val()).change();
    });
  });

  $(function() {
    return $('.offer_quantity').change(function() {
      return $(this).next().val($(this).val() * $(this).prev().val()).change();
    });
  });
...
(function() {
  $(function() {
    return $(".voyages_date").datepicker({
      dateFormat: 'yy-mm-dd',
      altField: "#date-alt",
